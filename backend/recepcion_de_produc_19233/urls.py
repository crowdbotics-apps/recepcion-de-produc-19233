"""recepcion_de_produc_19233 URL Configuration
...
admin.site.site_header = "Recepcion de productos"
admin.site.site_title = "Recepcion de productos Admin Portal"
admin.site.index_title = "Recepcion de productos Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Recepcion de productos API",
        default_version="v1",
        description="API documentation for Recepcion de productos App",
    ),
    public=True,
